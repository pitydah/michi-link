"""Canonical RTP v2 packet builder/parser for the E2E runner client side.
...
PCM S16LE interleaved L/R). Byte-compatible with the MS-09 E2E client of
the michi-music-stream repository.
"""
